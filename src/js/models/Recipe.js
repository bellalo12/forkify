...
export default class Recipe {
  ...
  async getRecipe(){
    try {
      ...
      alert('Something went wrong. Failed to fetch recipe')
    }
  }

  calcTime(){
    // Assuming that 15 min for each 3 ingredients
  ...
  parseIngredients(){
    ...
    const newIngredients = this.ingredients.map(el=>{
      ...
      //2 Remove Parenthese
      //For example: 2 jars (13 Ounces Each) Marshmallow Creme (13 Ounce ...) is the parentheses which we would like to replace it to ''
